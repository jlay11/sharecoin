...
QT_TRANSLATE_NOOP("freicoin-core", "An error occured while setting up the RPC port %i for listening: %s"),
...
QT_TRANSLATE_NOOP("freicoin-core", "Specify connection timeout (in milliseconds)"),
