...
Alternatively, install Qt Creator and open the `freicoin-qt.pro` file.
...
.. _`dependencies archive`: https://download.visucore.com/freicoin/qtgui_deps_1.zip
.. [#] PGP signature: https://download.visucore.com/freicoin/qtgui_deps_1.zip.sig (signed with RSA key ID `610945D0`_)
